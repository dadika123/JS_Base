let app = {
    ...
    insertPawns() {
        ...
        let whitePawnsRow = document.querySelectorAll('tr:nth-child(2)>td');
        ...
        let blackPawnsRow = document.querySelectorAll('tr:nth-child(7)>td');
    ...
    generateRow(startWithColor, rowNum) {
        ...
        for (let i = 0; i < this.config.cols.length; i++) {
            // 2.3 создаем переменную field, в которую записываем пур
